...
import matrix.client._SyncData;
import matrix.event.EventKey;
import matrix.event._MatrixAccountDataEvent;
import matrix.event._MatrixEphemeralEvent;
import matrix.event._MatrixPersistentEvent;
import matrix.event._MatrixStateEvent;
...
public class SyncDataJson extends MatrixJsonObject implements _SyncData {
    ...
    public class StateJson extends MatrixJsonObject implements State {
    ...
    public class TimelineJson extends MatrixJsonObject implements Timeline {
    ...
    public class EphemeralJson extends MatrixJsonObject implements Ephemeral {
    ...
    public class AccountDataJson extends MatrixJsonObject implements AccountData {
    ...
    public class InvitedRoomJson extends MatrixJsonObject implements InvitedRoom {
    ...
    public class UnreadNotificationsJson extends MatrixJsonObject implements UnreadNotifications {
    ...
    public class JoinedRoomJson extends MatrixJsonObject implements JoinedRoom {
    ...
    public class LeftRoomJson extends MatrixPersistentEventJson implements LeftRoom {
    ...
    public class RoomsJson extends MatrixJsonObject implements Rooms {
